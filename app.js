...
App({
  globalData: {
    ...
    host: "http://localhost:9345",//需要开始不校验本地ty
  },
  //用户登录
    ...
    wx.login({
      success: function (res) {
        if (res.code) {
          ...
          wx.request({
            method: 'post',
            // url: that.globalData.host + "/wx_graduation_voteforyou",//old
            url: that.globalData.host + "/wx_graduation_voteforyou/getVoteList",
            data: {
              "scene": "vote_login",
              'code': res.code,
